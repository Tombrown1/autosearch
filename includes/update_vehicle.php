...
if(isset($_POST['submit'])){
    ...
    update_vehicle_by_id($mysqli, $vehicle_name, $model, $vehicle_type, $manufacturer, $purchase_date, $registered_date, $plate_no, $vehicle_code, $owner_name, $owner_phone, $owner_address, $date);
